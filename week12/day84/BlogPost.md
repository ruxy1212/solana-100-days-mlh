...
- ✅ And lastly, ensure that the program does not block out legitimate users.

Read my complete, hands-on Solana program security checklist here 👇
https://dev.to/russell_oje/building-a-bulletproof-program-in-solana-a-hands-on-security-checklist-55om
