...
- Locate the mint address you saved in `week6/day36/Addresses.txt`.
...
- Locate the mint address from `week6/day37/Addresses.txt` and assign it to a variable:
...
- Locate the mint address from `week6/day38/Addresses.txt` and assign it to a variable:
...
- Review the `README.md` in this directory (`day39`) where a comparison table has been constructed using the collected values from your previous days.
